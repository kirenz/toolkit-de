...
3. **Sofortige Visualisierung von Ergebnissen:** Eines der besonderen Merkmale von Jupyter Notebook ist die Möglichkeit, Diagramme, Grafiken und andere Visualisierungen direkt im Notebook anzuzeigen. Dies gibt uns unmittelbares visuelles Feedback zu unseren Analysen und ist besonders wertvoll für explorative Datenanalysen.
   ...
   ![Jupyter Notebook-Zelle](../images/jupyter-notebook-mathe.png){#fig-jupyter-notebook-mathe width="100%" }
...
2. **Jupyter Notebook starten:**
   ...
   ![Jupyter in Anconda Navigator](../images/anaconda-navigator-jupyter.png){#fig-anaconda-navigator-jupyter width="50%" }
...
3. **Navigation zum richtigen Verzeichnis:**
   ...
   ![Ordner code in Jupyter Notebook](../images/jupyter-toolkit-lab-code.png){#fig-jupyter-toolkit-lab-code width="50%" }
...
4. **Erstellung eines neuen Notebooks:**
   ...
   ![Neuer Jupyter Notebook](../images/jupyter-notebook-new-notebook.png){#fig-jupyter-notebook-new-notebook width="50%" }
