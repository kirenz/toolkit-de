...
Diese Ordnerstruktur kann auch wie folgt dargestellt werden:
...
![Command Line Interface (CLI)](../images/terminalicon2.png){#fig-terminal fig-align="left" width=15%}
...
Die Befehlszeile ist ein leistungsstarkes Werkzeug zum Einrichten Ihrer Arbeitsumgebung. Sie ermöglicht eine  Kommunikation mit dem Betriebssystem über textbasierte Eingaben.
...
1. Um das Terminal in macOS zu öffnen, können Sie die Spotlight-Suche (`Cmd + Leertaste`) verwenden und "Terminal" eingeben oder über `Programme -> Dienstprogramme -> Terminal` navigieren.
