...
format:
  revealjs: 
    ...
    footer: Einrückung | Jan Kirenz
jupyter: python3
---


[⬇️ Jupyter Notebook herunterladen](../code/python-einrueckung.ipynb){download="python-einrueckung.ipynb"}
...
Beispielcode für die Erzeugung einer Funktion (wir behandeln Funktionen an einer [anderen Stelle des Buches](python-funktionen.qmd) im Detail):
