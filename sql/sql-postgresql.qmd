...
1. Laden Sie PostgreSQL von [dieser Website](https://www.enterprisedb.com/downloads/postgres-postgresql-downloads) herunter und installieren Sie es.
...
5. Passwort: Setzen Sie ein Passwort
6. Port: Akzeptieren Sie den standardmäßig vorgeschlagenen Port (üblicherweise 5432).
