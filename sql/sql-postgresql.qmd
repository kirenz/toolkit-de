...
*PostgreSQL*, oft ausgesprochen als "Post-gress-Q-L", ist ein fortschrittliches, quelloffenes relationales Datenbankmanagementsystem (RDBMS), das für seine Robustheit und seine Fähigkeiten zur Verwaltung komplexer Datenoperationen bekannt ist.

## Installation

1. Laden Sie PostgreSQL von [hier](https://www.enterprisedb.com/downloads/postgres-postgresql-downloads) herunter und installieren Sie es.
2. Wählen Sie das Standard-Installationsverzeichnis aus.
3. Wählen Sie diese Komponenten aus:
    - PostgreSQL Server
    - pgAdmin4
    - Kommandozeilenwerkzeuge
4. Wählen Sie das Standardverzeichnis für die Dateninstallation.
5. Passwort: Setzen Sie ein einprägsames Passwort; es ist kritisch, da es später nicht leicht geändert werden kann.
6. Port: Akzeptieren Sie den standardmäßig vorgeschlagenen Port (normalerweise 5432).
7. Gebietsschema: Setzen Sie es auf das Standardgebietsschema.
...
4. Wechseln Sie zum Reiter `Connection`:
    ...
    - Stellen Sie sicher, dass der Port derselbe ist wie bei der Installation.
...
Erstellen Sie eine Tabelle, um Daten über Marketingkampagnen zu speichern.
...
- **Zweite Zeile**: Fügt "Summer Festival" ein, eine kürzere Kampagne vom 1. bis 15. Juni 2023, mit einem höheren Budget von 10000 Dollar und nutzt "Soziale Medien".
