...
:::{.callout-note title="Installation in einem anderen Ordner"}
...
::: {.callout-note title="Virtuelle Umgebung .venv" collapse="true"}
...
::: {.callout-note title="Was ist uv.lock?" collapse="true"}
