...
Der resultierende DataFrame sieht so aus:
```
   Name  Alter     Stadt
0   Max     24    Berlin
1  Anna     30   Hamburg
...
Die gespeicherte CSV-Datei hat folgendes Format:
```
Name,Alter,Stadt
Max,24,Berlin
Anna,30,Hamburg
...
Jede Zeile der CSV-Datei entspricht einer Zeile im DataFrame, und jede Spalte entspricht einer Spalte im DataFrame. Die erste Zeile enthält die Spaltenüberschriften, welche die Namen der Spalten im DataFrame repräsentieren.
:::
