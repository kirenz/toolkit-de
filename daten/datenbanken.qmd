...
|---------------|--------------|-----------|----------------------|
| Strukturiert | Festes Schema, klar definierte Felder | - Tabellenkalkulationen<br>- Relationale Datenbanken | - MySQL<br>- PostgreSQL<br>- Oracle |
| Teilstrukturiert | Flexibles Schema, einige strukturierte Elemente | - JSON<br>- XML<br>- E-Mails | - MongoDB<br>- Couchbase<br>- Elasticsearch |
| Unstrukturiert | Kein vordefiniertes Datenmodell | - Textdokumente<br>- Bilder<br>- Videos | - Hadoop HDFS<br>- Amazon S3<br>- Apache Cassandra |
