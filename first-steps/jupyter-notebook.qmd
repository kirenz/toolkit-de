...
3. Schreiben Sie Ihren Text in Markdown, zum Beispiel:
   ...
   ```
4. Rendern Sie den Markdown-Text als formatierten Text, indem Sie `Shift+Enter` drücken (im Kontext von Markdown bezieht sich das Rendern auf den Prozess, bei dem der Markdown-Code in das formatierte Dokument umgewandelt wird, das in dem Webbrowser angezeigt wird.)
