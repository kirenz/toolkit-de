...
[⬇️ Jupyter Notebook herunterladen](../code/python-funktionen.ipynb){download="python-funktionen.ipynb"}

Funktionen helfen, modulare, wiederverwendbare Codeblöcke zu schreiben. In diesem Abschnitt wird das Definieren, Aufrufen und Dokumentieren von Funktionen demonstriert.
