...
NoSQL-Datenbanken beziehen sich auf hochleistungsfähige, nicht-relationale Datenspeicher. Anstatt Tabellen normalisierter Daten zu verbinden, speichern NoSQL-Datenbanken *unstrukturierte* oder *halbstrukturierte Daten*, oft in Schlüssel-Wert-Paaren oder JSON-Dokumenten. 

NoSQL-Datenbanken umfassen mehrere verschiedene Modelle zum Zugriff und zur Verwaltung von Daten, die jeweils für spezifische Anwendungsfälle geeignet sind ([Microsoft, 2021](https://docs.microsoft.com/en-us/dotnet/architecture/cloud-native/relational-vs-nosql-data)):
...
Hier sind einige Hauptmerkmale und -modelle von NoSQL-Datenbanken:
...
![Arten von NoSQL-Datenspeichern](../_static/img/types-of-nosql-datastores.png)
...
In dokumentenorientierten Datenbanken werden Daten in Form von Dokumenten gespeichert, die meist auf JSON (JavaScript Object Notation) basieren. Diese Dokumente enthalten nicht nur die Daten, sondern auch die Struktur der Daten, was eine große Flexibilität bietet. Beispiele sind MongoDB und CouchDB.

### Schlüssel-Wert-Speicher

Schlüssel-Wert-Datenbanken speichern Daten als eine Sammlung von Schlüssel-Wert-Paaren. Jede Datenstruktur besteht aus einem eindeutigen Schlüssel und einem Wert, der jede Art von Daten enthalten kann. Redis ist ein bekanntes Beispiel für einen Schlüssel-Wert-Speicher.

### Spaltenorientierter Speicher

Spaltenorientierte Datenbanken speichern Daten in Tabellen, aber im Gegensatz zu relationalen Datenbanken sind die Daten in Spalten anstatt in Reihen organisiert. Dies ermöglicht eine effiziente Speicherung und Abfrage von großen Datenmengen. Beispiele sind HBase und Cassandra.

### Graph-Speicher

Graph-Datenbanken speichern Daten in Form von Graphen, bei denen Knoten die Datenobjekte und Kanten die Beziehungen zwischen diesen Objekten darstellen. Dies ermöglicht komplexe Abfragen von Beziehungen. Ein bekanntes Beispiel ist Neo4j.
